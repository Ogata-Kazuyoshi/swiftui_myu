...
func getRequest(completion: @escaping ([[String: Any]]) -> Void) {
    AF.request("https://drawing-traveler-7a488b236b7c.herokuapp.com/api/v1/images", method: .get)
        .response { response in
            ...
            do {
                ...
                print("Error decoding JSON 1: \(error)")
                print("Error decoding JSON 2: \(response)")
            }
        }
}
